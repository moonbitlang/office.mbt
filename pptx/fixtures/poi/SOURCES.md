<!-- Modified for office.mbt: use the root shared validator command. -->
# Corpus provenance
...
From the repository root, validate any candidate before committing:

```bash
bash scripts/validate_pptx.sh pptx/fixtures/poi/<file.pptx>
```
