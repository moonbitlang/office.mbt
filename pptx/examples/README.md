<!-- Modified for office.mbt: official module namespace and historical document paths. -->
# moon-pptx — Examples
...
on `moonbitlang/pptx` exactly the way a downstream consumer would.
...
and the [mooncakes docs](https://mooncakes.io/docs/moonbitlang/pptx).
...
- [ROADMAP.md](../upstream/ROADMAP.md) — direction, open gaps, and architecture decisions.
- [CHANGELOG.md](../upstream/CHANGELOG.md) — what changed in this version.
