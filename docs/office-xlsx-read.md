...
Run `moonx moonbitlang/office help xlsx` for the installed command catalog and
`moonx moonbitlang/office help <command> --json` for the declared format variants,
