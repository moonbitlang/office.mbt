...
It runs `scripts/check_parity_preflight_matrix_smoke_contract_1.sh` as a
preflight matrix smoke contract preflight.
Set `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_PREFLIGHT=1` to bypass this
preflight.
It runs `scripts/check_parity_preflight_matrix_smoke_contract_2.sh` as a
...
It runs `scripts/check_parity_preflight_matrix_smoke_contract_3.sh`
...
It runs `scripts/check_parity_preflight_matrix_smoke_contract_4.sh`
...
to bypass this preflight.
It runs `scripts/check_parity_preflight_matrix_smoke_contract_5.sh`
...
to bypass this preflight.
It runs `scripts/check_parity_preflight_matrix_smoke_contract_6.sh`
...
to bypass this preflight.
It runs `scripts/check_parity_preflight_matrix_smoke_contract_7.sh`
...
to bypass this preflight.
It runs `scripts/check_parity_preflight_matrix_smoke_contract_8.sh`
...
to bypass this preflight.
It runs `scripts/check_parity_preflight_matrix_smoke_contract_9.sh`
...
to bypass this preflight.
It runs `scripts/check_parity_preflight_matrix_smoke_contract_10.sh`
...
to bypass this preflight.
It runs `scripts/check_parity_preflight_matrix_smoke_contract_11.sh`
...
to bypass this preflight.
It runs `scripts/check_parity_preflight_matrix_smoke_contract_12.sh`
...
to bypass this preflight.
It runs `scripts/check_parity_preflight_matrix_smoke_contract_13.sh`
...
to bypass this preflight.
It runs `scripts/check_parity_preflight_matrix_smoke_contract_14.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_1.sh` to validate
matrix-smoke checker JSON schema and CLI usage contract behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_1.sh --json` for
machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_2.sh` to
validate matrix-smoke contract-checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_2.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_3.sh`
to validate matrix-smoke contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_3.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_4.sh`
to validate matrix-smoke contract-contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_4.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_5.sh`
to validate matrix-smoke contract-contract-contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_5.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_6.sh`
to validate matrix-smoke contract-contract-contract-contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_6.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_7.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_7.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_8.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_8.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_9.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_9.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_10.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_10.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_11.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_11.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_12.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_12.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_13.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_13.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_14.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_14.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_15.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_15.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_16.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_16.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_17.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_17.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_18.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_18.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_19.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_19.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_20.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_20.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_21.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_21.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_22.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_22.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_23.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_23.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_24.sh`
...
Use `scripts/check_parity_preflight_matrix_smoke_contract_24.sh --json`
for machine-readable contract-check output in CI.
...
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x77.sh`
to validate matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x77.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x78.sh`
to validate matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x78.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x79.sh`
to validate matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x79.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x80.sh`
to validate matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x80.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x81.sh`
to validate matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x81.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x82.sh`
to validate matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x82.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x83.sh`
to validate matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x83.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x84.sh`
to validate matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x84.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x85.sh`
to validate matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x85.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x86.sh`
to validate matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker JSON schema and CLI usage behavior.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x86.sh --json`
for machine-readable contract-check output in CI.
Use `scripts/check_parity_preflight_matrix_smoke_contract_x87.sh`
to validate matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker JSON schema and CLI usage behavior.
