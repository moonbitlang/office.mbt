...
payload = {
    ...
    "SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_PREFLIGHT": {
        "value": os.getenv("SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_PREFLIGHT"),
        "default": "0",
    },
    "SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_PREFLIGHT": {
        "value": os.getenv("SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_PREFLIGHT"),
        "default": "0",
    },
    "SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_PREFLIGHT": {
        "value": os.getenv("SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_PREFLIGHT"),
        "default": "0",
    },
    "SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT": {
        "value": os.getenv("SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT"),
        "default": "0",
    },
    "SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT": {
        "value": os.getenv("SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT"),
        "default": "0",
    },
...
echo "- SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_PREFLIGHT=${SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_PREFLIGHT:-<unset>} (default: 0)"
echo "- SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_PREFLIGHT=${SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_PREFLIGHT:-<unset>} (default: 0)"
echo "- SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_PREFLIGHT=${SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_PREFLIGHT:-<unset>} (default: 0)"
echo "- SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT=${SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT:-<unset>} (default: 0)"
echo "- SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT=${SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT:-<unset>} (default: 0)"
