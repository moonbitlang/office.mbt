...
| `unicode_cjk_unified_ideographs_u4e00.pdf` | Extracts 1,512,647 characters after form-XObject recursion, shared-font extractor caching, Markdown control-scalar sanitization, and first-pass positioned text ordering. | Extracts 1,518,212 characters. | The original page-heading-only failure is fixed, pdflite no longer emits raw C0/C1 controls, and chart pages now follow row/column reading order. Remaining differences need text-quality review, especially unresolved glyph placeholders and table-cell polish. |
