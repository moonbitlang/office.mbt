...
1. Low-level byte and input layer.
   ...
   CamlPDF-style filled-byte construction and byte/int-array conversion
   helpers, a non-mutating byte-map replacement for CamlPDF's mutable
   `bytes_selfmap`, an in-memory byte-output builder, and black-box tests.
