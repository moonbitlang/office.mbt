...
4. Page and content layer.
   ...
   inline-image rewriting reuse stable standard names. Single-stage Flate inline
   images without `/DecodeParms` now reuse the prefix-decoded payload instead of
   copying encoded bytes and decoding them again through stream-filter dispatch.
   Page-tree, page
