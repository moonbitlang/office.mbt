...
5. Text, font, color, function, and image layer.
   ...
   GBK-EUC-UCS2, B5pc, HKSCS/Adobe-CNS1, and KSC-EUC/Adobe-Korea1-UCS2
   mapping-table fallbacks, plus KSCpc-EUC multi-codepoint fallback when
   `/ToUnicode` is absent,
   ...
   beyond the RKSJ single-byte, GB-EUC, GBpc-EUC, Big5, B5pc, HKSCS, UHC,
   GBK, KSC-EUC, and KSCpc-EUC fallbacks when `/ToUnicode` is absent, JPEG
...
- Not covered enough: broader built-in non-UCS2 predefined CMap mapping tables
  beyond the RKSJ single-byte, GB-EUC, GBpc-EUC, Big5, B5pc, HKSCS, UHC, GBK,
