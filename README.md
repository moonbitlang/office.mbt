...
| [pptx](pptx/README.mbt.md) | `moonbitlang/pptx` (source import) | PPTX reading, building, and writing |
...
publishing. The root publish workflow publishes the seven release-enabled modules
...
The `pptx/` module is a first-stage import of `t-ujiie-g/moon-pptx`. It is
included in workspace checks and tests but excluded from automated publication
and Office CLI integration. See [its provenance and scope](pptx/UPSTREAM.md).
