...
- Next item: **187** (continue residual hotspot reduction in `xlsx/formula_builtins.mbt`, part 18, using wbtest-targeted coverage summary as the comparable metric).
