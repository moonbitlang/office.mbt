...
- Next item: **186** (continue residual hotspot reduction in `xlsx/formula_builtins.mbt`, part 17, using wbtest-targeted coverage summary as the comparable metric).
