...
- Next item: **188** (continue residual hotspot reduction in `xlsx/formula_builtins.mbt`, part 19, using wbtest-targeted coverage summary as the comparable metric).
