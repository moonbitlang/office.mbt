...
- Next item: **198** (continue residual hotspot reduction in `xlsx/formula_builtins.mbt`, part 29, using wbtest-targeted coverage summary as the comparable metric).
