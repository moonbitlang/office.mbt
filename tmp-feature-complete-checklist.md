...
- [x] 327. Wire preflight-status helper regression check into aggregate gate preflight.
  - DoD: enforce preflight-status-helper contract checks in aggregate gates by
    default with explicit opt-out control.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
      - runs `scripts/check_parity_preflight_status_helper.sh` by default
      - adds `SKIP_PARITY_PREFLIGHT_STATUS_HELPER_PREFLIGHT=1` skip toggle
      - prints the new toggle in startup env diagnostics
    - Updated `scripts/show_parity_preflight_status.sh`:
      - adds `preflight_status_helper_preflight` status in plain/JSON output
      - includes `SKIP_PARITY_PREFLIGHT_STATUS_HELPER_PREFLIGHT` in JSON env payload
    - Updated `scripts/show_parity_env.sh`:
      - includes `SKIP_PARITY_PREFLIGHT_STATUS_HELPER_PREFLIGHT` in plain/JSON output
    ...
    - Updated docs:
      ...
      - `docs/parity-commands.md`
  - Validation gates:
    - `SKIP_PARITY_PREFLIGHT_STATUS_HELPER_PREFLIGHT=1 scripts/show_parity_env.sh --json`
    - `SKIP_PARITY_PREFLIGHT_STATUS_HELPER_PREFLIGHT=1 scripts/show_parity_preflight_status.sh --json`
    - `SHOW_PARITY_PREFLIGHT_STATUS=json SKIP_PARITY_WRAPPER_PREFLIGHT=1 SKIP_PARITY_ENV_HELPER_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_STATUS_HELPER_PREFLIGHT=1 SKIP_PARITY_DOCS_PREFLIGHT=1 scripts/test_parity_gates.sh`
    - `scripts/check_parity_preflight_status_helper.sh`
    - `moon check --deny-warn`
    - `moon info && moon fmt`
...
- [x] 341. Add `--json` output mode for preflight matrix smoke checker.
  - DoD: expose machine-readable matrix-smoke check results while preserving
    existing non-JSON pass/fail behavior and exit codes.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke.sh`:
...
- [x] 343. Wire matrix-smoke contract checker into aggregate gate preflight flow.
  - DoD: run matrix-smoke contract checker in aggregate preflight with a
    dedicated skip toggle and keep helper/env/status/checker surfaces aligned.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
    ...
    - Updated helper/status/env consistency:
      - `scripts/show_parity_preflight_status.sh` includes
        ...
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_PREFLIGHT` env key
      - `scripts/show_parity_env.sh` includes
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_PREFLIGHT` in plain/JSON output
      - `scripts/check_parity_env_helper.sh` requires the new skip key
      - `scripts/check_parity_preflight_status_helper.sh` requires new
        status/env keys and verifies skipped-resolution behavior
      - `scripts/check_parity_gate_skip_toggles.sh` expects the new skip key
  ...
  - Validation gates:
    ...
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `SKIP_PARITY_WRAPPER_PREFLIGHT=1 SKIP_PARITY_ENV_HELPER_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_STATUS_HELPER_PREFLIGHT=1 SKIP_PARITY_GATE_TOGGLE_PREFLIGHT=1 SKIP_PARITY_GATE_TOGGLE_CONTRACT_PREFLIGHT=1 SKIP_PARITY_GATE_SHOW_TOGGLE_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_PREFLIGHT=1 SKIP_PARITY_DOCS_PREFLIGHT=1 SHOW_PARITY_PREFLIGHT_STATUS=json SHOW_PARITY_PREFLIGHT_STATUS_COMPACT=1 SEMANTIC_PARITY_ARGS='--scenario cf --skip-validate' SEMANTIC_PARITY_SUMMARY_ARGS='--top-slowest 1' scripts/test_parity_gates.sh`
    - `moon check --deny-warn`
    - `moon info && moon fmt`
...
- [x] 345. Add contract checker for matrix-smoke contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract checker with a
...
- [x] 346. Wire matrix-smoke contract-contract checker into aggregate gate preflight flow.
  - DoD: run matrix-smoke contract-contract checker in aggregate preflight with
    a dedicated skip toggle and keep helper/env/status/checker surfaces aligned.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
    ...
    - Updated helper/status/env consistency:
      - `scripts/show_parity_preflight_status.sh` includes
        ...
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_PREFLIGHT` env key
      - `scripts/show_parity_env.sh` includes
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_PREFLIGHT` in plain/JSON output
      - `scripts/check_parity_env_helper.sh` requires the new skip key
      - `scripts/check_parity_preflight_status_helper.sh` requires new
        status/env keys and verifies skipped-resolution behavior
      - `scripts/check_parity_gate_skip_toggles.sh` expects the new skip key
...
- [x] 347. Add `--json` output mode for matrix-smoke contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 348. Add contract checker for matrix-smoke contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract checker with
...
- [x] 349. Wire matrix-smoke contract-contract-contract checker into aggregate gate preflight flow.
  - DoD: run matrix-smoke contract-contract-contract checker in aggregate
    preflight with a dedicated skip toggle and keep helper/env/status/checker
    surfaces aligned.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
    ...
    - Updated helper/status/env consistency:
      - `scripts/show_parity_preflight_status.sh` includes
        ...
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` env key
      - `scripts/show_parity_env.sh` includes
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` in plain/JSON output
      - `scripts/check_parity_env_helper.sh` requires the new skip key
      - `scripts/check_parity_preflight_status_helper.sh` requires new
        status/env keys and verifies skipped-resolution behavior
      - `scripts/check_parity_gate_skip_toggles.sh` expects the new skip key
  ...
  - Validation gates:
    ...
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `SKIP_PARITY_WRAPPER_PREFLIGHT=1 SKIP_PARITY_ENV_HELPER_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_STATUS_HELPER_PREFLIGHT=1 SKIP_PARITY_GATE_TOGGLE_PREFLIGHT=1 SKIP_PARITY_GATE_TOGGLE_CONTRACT_PREFLIGHT=1 SKIP_PARITY_GATE_SHOW_TOGGLE_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT=1 SKIP_PARITY_DOCS_PREFLIGHT=1 SHOW_PARITY_PREFLIGHT_STATUS=json SHOW_PARITY_PREFLIGHT_STATUS_COMPACT=1 SEMANTIC_PARITY_ARGS='--scenario cf --skip-validate' SEMANTIC_PARITY_SUMMARY_ARGS='--top-slowest 1' scripts/test_parity_gates.sh`
    - `moon check --deny-warn`
    - `moon info && moon fmt`

## Active Item

- [x] 350. Add `--json` output mode for matrix-smoke contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 351. Add contract checker for matrix-smoke contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract
...
- [x] 352. Wire matrix-smoke contract-contract-contract-contract checker into aggregate gate preflight flow.
  - DoD: run matrix-smoke contract-contract-contract-contract checker in
    aggregate preflight with a dedicated skip toggle and keep helper/env/status/checker
    surfaces aligned.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
    ...
    - Updated helper/status/env consistency:
      - `scripts/show_parity_preflight_status.sh` includes
        ...
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` env key
      - `scripts/show_parity_env.sh` includes
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` in plain/JSON output
      - `scripts/check_parity_env_helper.sh` requires the new skip key
      - `scripts/check_parity_preflight_status_helper.sh` requires new
        status/env keys and verifies skipped-resolution behavior
      - `scripts/check_parity_gate_skip_toggles.sh` expects the new skip key
...
- [x] 353. Add `--json` output mode for matrix-smoke contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 354. Add contract checker for matrix-smoke contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 355. Wire matrix-smoke contract-contract-contract-contract-contract checker into aggregate gate preflight flow.
  - DoD: run matrix-smoke contract-contract-contract-contract-contract checker
    in aggregate preflight with a dedicated skip toggle and keep helper/env/status/checker
    surfaces aligned.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
    ...
    - Updated helper/status/env consistency:
      - `scripts/show_parity_preflight_status.sh` includes
        ...
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` env key
      - `scripts/show_parity_env.sh` includes
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` in plain/JSON output
      - `scripts/check_parity_env_helper.sh` requires the new skip key
      - `scripts/check_parity_preflight_status_helper.sh` requires new
        status/env keys and verifies skipped-resolution behavior
      - `scripts/check_parity_gate_skip_toggles.sh` expects the new skip key
  ...
  - Validation gates:
    ...
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `SKIP_PARITY_WRAPPER_PREFLIGHT=1 SKIP_PARITY_ENV_HELPER_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_STATUS_HELPER_PREFLIGHT=1 SKIP_PARITY_GATE_TOGGLE_PREFLIGHT=1 SKIP_PARITY_GATE_TOGGLE_CONTRACT_PREFLIGHT=1 SKIP_PARITY_GATE_SHOW_TOGGLE_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT=1 SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT=1 SKIP_PARITY_DOCS_PREFLIGHT=1 SHOW_PARITY_PREFLIGHT_STATUS=json SHOW_PARITY_PREFLIGHT_STATUS_COMPACT=1 SEMANTIC_PARITY_ARGS='--scenario cf --skip-validate' SEMANTIC_PARITY_SUMMARY_ARGS='--top-slowest 1' scripts/test_parity_gates.sh`
    - `moon check --deny-warn`
    - `moon info && moon fmt`

## Active Item

- [x] 356. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 357. Add contract checker for matrix-smoke contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 358. Wire matrix-smoke contract-contract-contract-contract-contract-contract checker into aggregate gate preflight flow.
  - DoD: run matrix-smoke contract-contract-contract-contract-contract-contract checker
    in aggregate preflight with a dedicated skip toggle and keep helper/env/status/checker
    surfaces aligned.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
    ...
    - Updated helper/status/env consistency:
      - `scripts/show_parity_preflight_status.sh` includes
        ...
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` env key
      - `scripts/show_parity_env.sh` includes
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` in plain/JSON output
      - `scripts/check_parity_env_helper.sh` requires the new skip key
      - `scripts/check_parity_preflight_status_helper.sh` requires new
        status/env keys and verifies skipped-resolution behavior
      - `scripts/check_parity_gate_skip_toggles.sh` expects the new skip key
...
- [x] 359. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 360. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 361. Wire matrix-smoke contract-contract-contract-contract-contract-contract-contract checker into aggregate gate preflight flow.
  - DoD: run matrix-smoke contract-contract-contract-contract-contract-contract-contract checker
    in aggregate preflight with a dedicated skip toggle and keep helper/env/status/checker
    surfaces aligned.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
    ...
    - Updated helper/status/env consistency:
      - `scripts/show_parity_preflight_status.sh` includes
        ...
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` env key
      - `scripts/show_parity_env.sh` includes
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` in plain/JSON output
      - `scripts/check_parity_env_helper.sh` requires the new skip key
      - `scripts/check_parity_preflight_status_helper.sh` requires new
        status/env keys and verifies skipped-resolution behavior
      - `scripts/check_parity_gate_skip_toggles.sh` expects the new skip key
...
- [x] 362. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 363. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 364. Wire matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract checker into aggregate gate preflight flow.
  - DoD: run matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract checker
    in aggregate preflight with a dedicated skip toggle and keep helper/env/status/checker
    surfaces aligned.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
    ...
    - Updated helper/status/env consistency:
      - `scripts/show_parity_preflight_status.sh` includes
        ...
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` env key
      - `scripts/show_parity_env.sh` includes
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` in plain/JSON output
      - `scripts/check_parity_env_helper.sh` requires the new skip key
      - `scripts/check_parity_preflight_status_helper.sh` requires new
        status/env keys and verifies skipped-resolution behavior
      - `scripts/check_parity_gate_skip_toggles.sh` expects the new skip key
...
- [x] 365. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 366. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 367. Wire matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract checker into aggregate gate preflight flow.
  - DoD: run matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract checker
    in aggregate preflight with a dedicated skip toggle and keep helper/env/status/checker
    surfaces aligned.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
    ...
    - Updated helper/status/env consistency:
      - `scripts/show_parity_preflight_status.sh` includes
        ...
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` env key
      - `scripts/show_parity_env.sh` includes
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` in plain/JSON output
      - `scripts/check_parity_env_helper.sh` requires the new skip key
      - `scripts/check_parity_preflight_status_helper.sh` requires new
        status/env keys and verifies skipped-resolution behavior
      - `scripts/check_parity_gate_skip_toggles.sh` expects the new skip key
...
- [x] 368. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 369. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 370. Wire matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker into aggregate gate preflight flow.
  - DoD: run matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker
    in aggregate preflight with a dedicated skip toggle and keep helper/env/status/checker
    surfaces aligned.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
    ...
    - Updated helper/status/env consistency:
      - `scripts/show_parity_preflight_status.sh` includes
        ...
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` env key
      - `scripts/show_parity_env.sh` includes
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` in plain/JSON output
      - `scripts/check_parity_env_helper.sh` requires the new skip key
      - `scripts/check_parity_preflight_status_helper.sh` requires new
        status/env keys and verifies skipped-resolution behavior
      - `scripts/check_parity_gate_skip_toggles.sh` expects the new skip key
...
- [x] 371. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 372. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 373. Wire matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker into aggregate gate preflight flow.
  - DoD: run matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker
    in aggregate preflight with a dedicated skip toggle and keep helper/env/status/checker
    surfaces aligned.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
    ...
    - Updated helper/status/env consistency:
      - `scripts/show_parity_preflight_status.sh` includes
        ...
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` env key
      - `scripts/show_parity_env.sh` includes
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` in plain/JSON output
      - `scripts/check_parity_env_helper.sh` requires the new skip key
      - `scripts/check_parity_preflight_status_helper.sh` requires new
        status/env keys and verifies skipped-resolution behavior
      - `scripts/check_parity_gate_skip_toggles.sh` expects the new skip key
...
- [x] 374. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 375. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 376. Wire matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker into aggregate gate preflight flow.
  - DoD: run matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker
    in aggregate preflight with a dedicated skip toggle and keep helper/env/status/checker
    surfaces aligned.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
    ...
    - Updated helper/status/env consistency:
      - `scripts/show_parity_preflight_status.sh` includes
        ...
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` env key
      - `scripts/show_parity_env.sh` includes
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` in plain/JSON output
      - `scripts/check_parity_env_helper.sh` requires the new skip key
      - `scripts/check_parity_preflight_status_helper.sh` requires new
        status/env keys and verifies skipped-resolution behavior
      - `scripts/check_parity_gate_skip_toggles.sh` expects the new skip key
...
- [x] 377. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 378. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 379. Wire matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker into aggregate gate preflight flow.
  - DoD: run matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker
    in aggregate preflight with a dedicated skip toggle and keep helper/env/status/checker
    surfaces aligned.
  - Delivered:
    - Updated `scripts/test_parity_gates.sh`:
    ...
    - Updated helper/status/env consistency:
      - `scripts/show_parity_preflight_status.sh` includes
        ...
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` env key
      - `scripts/show_parity_env.sh` includes
        `SKIP_PARITY_PREFLIGHT_MATRIX_SMOKE_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_CONTRACT_PREFLIGHT` in plain/JSON output
      - `scripts/check_parity_env_helper.sh` requires the new skip key
      - `scripts/check_parity_preflight_status_helper.sh` requires new
        status/env keys and verifies skipped-resolution behavior
      - `scripts/check_parity_gate_skip_toggles.sh` expects the new skip key
...
- [x] 380. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 381. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 383. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 384. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 385. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 386. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 387. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 388. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 389. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 390. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 391. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 392. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 393. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 394. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 395. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 396. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 397. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 398. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 399. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 400. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 401. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 402. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 403. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
...
- [x] 404. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
...
- [x] 405. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x25.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x25.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 406. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x25.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x25.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 407. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x26.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x26.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 408. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x26.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x26.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 409. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x27.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x27.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 410. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x27.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x27.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 411. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x28.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x28.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 412. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x28.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x28.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 413. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x29.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x29.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 414. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x29.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x29.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 415. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x30.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x30.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 416. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x30.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x30.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 417. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x31.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x31.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 418. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x31.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x31.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 419. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x32.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x32.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 420. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x32.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x32.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 421. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x33.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x33.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 422. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x33.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x33.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 423. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x34.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x34.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 424. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x34.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x34.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 426. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x35.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x35.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 427. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x36.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x36.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 428. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x36.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x36.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 429. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x37.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x37.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 430. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x37.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x37.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 431. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x38.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x38.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 432. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x38.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x38.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 433. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x39.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x39.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 434. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x39.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x39.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 435. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x40.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x40.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 436. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x40.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x40.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 437. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x41.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x41.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 438. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x41.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract_contract_contract_contract_contract_contract_contract_contract_contract_contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x41.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 439. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x42.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x42.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 440. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x42.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x42.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 441. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x43.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x43.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 442. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x43.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x43.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 443. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x44.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x44.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 444. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x44.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x44.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 445. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x45.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x45.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 446. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x45.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x45.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 447. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x46.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x46.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 448. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x46.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x46.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 449. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x47.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x47.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 450. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x47.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x47.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 451. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x48.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x48.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 452. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x48.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x48.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 453. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x49.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x49.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 454. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x49.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x49.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 455. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x50.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x50.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 456. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x50.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x50.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 457. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x51.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x51.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 458. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x51.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract_contract_contract_contract_contract_contract_contract_contract_contract_contract_contract_contract_contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x51.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 459. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x52.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x52.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 460. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x52.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x52.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 461. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x53.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x53.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 462. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x53.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 463. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x54.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x54.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 464. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x54.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 465. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x55.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x55.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 466. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x55.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 467. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x56.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x56.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 468. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x56.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 469. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x57.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x57.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 470. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x57.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 471. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x58.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x58.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 472. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x58.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 473. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x59.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x59.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 474. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x59.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 475. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x60.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x60.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 476. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x60.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 477. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x61.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x61.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 478. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x61.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 479. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x62.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x62.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 480. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x62.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 481. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x63.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x63.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 482. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x63.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 483. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x64.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x64.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 484. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x64.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 485. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x65.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x65.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 486. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x65.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 487. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x66.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x66.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 488. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x66.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 489. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x67.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x67.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
...
- [x] 490. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x67.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 491. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x68.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x68.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x68.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x68.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 492. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x68.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 493. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x69.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x69.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x69.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x69.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 494. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x69.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 495. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x70.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x70.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x70.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x70.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 496. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x70.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x70.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 497. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x71.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x71.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x71.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x71.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 498. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
    ...
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x71.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x71.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 499. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x72.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x72.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x72.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x72.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 500. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x73.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x72.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x72.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 501. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x73.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x73.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x73.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x73.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 502. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x74.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x73.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x73.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 503. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x74.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x74.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x74.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x74.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 504. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x75.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x74.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x74.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 505. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x75.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x75.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x75.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x75.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 506. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x76.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x75.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x75.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 507. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x76.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x76.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x76.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x76.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 508. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x77.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x76.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
...
- [x] 509. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x77.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x77.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x77.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x77.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 510. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x78.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x77.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 511. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x78.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x78.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x78.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x78.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 512. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x79.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x78.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 513. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x79.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x79.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x79.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x79.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 514. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x80.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x79.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 515. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x80.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x80.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x80.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x80.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 516. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x81.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x80.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 517. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x81.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
  ...
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x81.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x81.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 519. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x82.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x82.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x82.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x82.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 520. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x83.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x82.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 521. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x83.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x83.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x83.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x83.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 522. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x84.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x83.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 523. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x84.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x84.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x84.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x84.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 524. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x85.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x84.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- [x] 525. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x85.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x85.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x85.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x85.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 526. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x86.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x85.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
      - invalid args return code `2` with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x85.sh [--json]`
    - Added script to wrapper/docs coverage tracking:
      - `scripts/check_parity_wrappers.sh`
...
- [x] 527. Add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker.
  - DoD: expose machine-readable contract-check results while preserving
    default plain output and exit semantics.
  - Delivered:
    - Refactored `scripts/check_parity_preflight_matrix_smoke_contract_x86.sh`:
      - adds CLI parsing with `--json` support
      - emits structured JSON payload:
        - top-level `result` (`pass|fail`)
        - per-check entries under `checks[]` with `check`, `ok`, `detail`
      ...
      - preserves non-zero exit on any failed check
      - validates invalid args with usage:
        - `Usage: scripts/check_parity_preflight_matrix_smoke_contract_x86.sh [--json]`
    - Updated docs for JSON mode usage:
      - `docs/parity-commands.md`
      - `docs/excelize-parity.md`
  - Validation gates:
    - `moon clean`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x86.sh`
    - `scripts/check_parity_preflight_matrix_smoke_contract_x86.sh --json`
    - `scripts/check_parity_wrappers.sh`
    - `scripts/check_parity_docs_wrapper_coverage.sh`
    - `scripts/check_parity_docs_refs.sh`
    - `moon check --deny-warn`
...
- [x] 528. Add contract checker for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker `--json` output and CLI usage.
  - DoD: lock JSON/CLI behavior of matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract
    checker with a dedicated regression guard script and wire it into
    wrapper/docs coverage.
  - Delivered:
    - Added executable script:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x87.sh`
    - Contract checker validates:
      - `scripts/check_parity_preflight_matrix_smoke_contract_x86.sh --json` contains:
        - top-level `result` in `pass|fail`
        - top-level `checks` list
        - per-entry `check`, `ok`, `detail` fields with expected types
        - required check names for pattern and matrix-smoke-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract schema checks
...
- Next item: **529** (add `--json` output mode for matrix-smoke contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract-contract checker).
