...
- Next item: **197** (continue residual hotspot reduction in `xlsx/formula_builtins.mbt`, part 28, using wbtest-targeted coverage summary as the comparable metric).
