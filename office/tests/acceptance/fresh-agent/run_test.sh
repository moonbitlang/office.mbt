...

{
  ...
  printf '%s\n' \
    ...
    '  /usr/bin/printf "%s\\n" '\''{"schema":"docx.edit/2","ops":[{"op":"set_run_text","params":{"at":"p[2]/r[1]","expect":"F1B-DOCX-TEMPLATE-V1","text":"F1B-DOCX-TEMPLATE-V1"}}]}'\'' > "$runtime/docx/edit.json"' \
