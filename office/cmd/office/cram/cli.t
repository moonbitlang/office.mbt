...
the XML.
  ...
  $ office.exe find "$TESTDIR/../../../../docx2html/tests/cram/fixtures/single-paragraph.docx" --text "on imported" --json | jq -c '{schema:.data.schema,total:.data.matches_total,actionable:.data.actionable_total,unactionable:.data.unactionable_total}'
