...
and JSONL inventories without deferred PowerPoint or MCP entries.
  ...
  {"schema":"office.output/1","success":true,"capability_schema":"office.capabilities/2","fingerprint":"crc32:f60a7c98","names":["docx","xlsx","help","identify","outline","get","text","query","validate","dump","replay","issues","preview","create","template","annotate","batch","raw"]}

  $ office.exe help all --jsonl | jq -s -c 'map({schema,fingerprint,kind,name})'
  [{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"format","name":"docx"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"format","name":"xlsx"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"help"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"identify"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"outline"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"get"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"text"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"query"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"validate"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"dump"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"replay"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"issues"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"preview"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"create"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"template"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"annotate"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"batch"},{"schema":"office.capability/2","fingerprint":"crc32:f60a7c98","kind":"command","name":"raw"}]
