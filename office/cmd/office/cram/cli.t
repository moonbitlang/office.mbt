...
and JSONL inventories without deferred PowerPoint or MCP entries.
  ...
  {"schema":"office.output/1","success":true,"capability_schema":"office.capabilities/2","fingerprint":"crc32:fd3afeb9","names":["docx","xlsx","help","identify","outline","get","text","query","find","replace","validate","dump","replay","issues","preview","render","create","template","edit","annotate","batch","raw"]}

  $ office.exe help all --jsonl | jq -s -c 'map({schema,fingerprint,kind,name})'
  [{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"format","name":"docx"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"format","name":"xlsx"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"help"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"identify"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"outline"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"get"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"text"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"query"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"find"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"replace"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"validate"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"dump"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"replay"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"issues"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"preview"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"render"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"create"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"template"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"edit"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"annotate"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"batch"},{"schema":"office.capability/2","fingerprint":"crc32:fd3afeb9","kind":"command","name":"raw"}]
...
selects a candidate while changing nothing.
  ...
  $ office.exe replace "$TESTDIR/../../../../docx2html/tests/cram/fixtures/single-paragraph.docx" fr-mp.docx --text "imported" --with "borrowed" --dry-run --json | jq -c '.data.matches[0] | {ordinal,path,range,text,actionable}'
  {"ordinal":1,"path":"p[1]","range":{"start":11,"end":19,"unit":"utf16"},"text":"imported","actionable":true}
