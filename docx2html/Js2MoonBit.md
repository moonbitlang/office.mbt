...
- Mammoth's style-map document matcher grammar is strict for malformed suffix values too: unterminated style-name/highlight strings and non-integer list levels are warnings, not broad fallback matchers. Repeated matcher suffixes are allowed, with later suffixes overriding earlier ones.
